...
class JsonResponse
{
    ...
    public function storeResponse(bool $result): HttpJsonResponse
    {
        if ($result) {
            return $this->okResponse();
        }

        return $this->errorResponse(['_error' => __('general.store_error'), '_errorCode' => ErrorCode::SERVER_ERROR]);
    }

    public function updateResponse(bool $result): HttpJsonResponse
    {
        if ($result) {
            return $this->okResponse();
        }

        return $this->errorResponse(['_error' => __('general.update_error'), '_errorCode' => ErrorCode::SERVER_ERROR]);
    }
    ...
    public function deleteResponse(bool $result): HttpJsonResponse
    {
        ...
        return $this->errorResponse(['_error' => __('general.delete_error'), '_errorCode' => ErrorCode::SERVER_ERROR]);
    }
